...
| 8b | Observabilidad y la alerta | 2 | **Santiago** |
| 9 | Operación | 1 | **Daniel** |
| 10 | Cierre | 0,75 | **Santiago** |

**Totales:** David 4,5 · Michael 6 · Santiago 7,75 · Daniel 1.
...
David ──────────► Michael ──────────► Santiago ──────► Daniel ──► Santiago
 0, 1, 2, 2b       3, 3b, 4, 5         6, 7, 8, 8b        9          10
   4,5 min           6 min               7 min          1 min      0,75
```
...
- Los bloques 0–2b, 8, 8b y 9 funcionan sobre un stack recién sembrado, sin
  depender de nadie.
